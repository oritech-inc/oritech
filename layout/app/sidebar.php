<div class="offcanvas-sm offcanvas-start p-0" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
    ...
    <a class="navbar-brand fs-6 text-white" href="#">
        <img class="img-fluid hidden-xs" src="<?=$config['img']['logo']?>icon.png" height="32" width="32">
        <span class="nav-text"><?=$config['app']['name'] ?></span>
    </a>

    <div class="offcanvas-body d-md-flex flex-column p-0 overflow-y-">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex justify-content-between gap-2" href="#" data-link="booking"
                    data-type="sidebar" id="booking">
                    <svg class="bi lnk-icon">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex justify-content-between gap-2" href="#" data-link="service"
                    data-type="sidebar" id="service">
                    <svg class="bi lnk-icon">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex justify-content-between gap-2" href="#" data-link="user" data-type="sidebar"
                    id="user">
                    <svg class="bi lnk-icon">
